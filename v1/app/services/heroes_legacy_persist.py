...
def persist_dispatch_pending_items(
    ...
    *,
    ...
    """Persiste linhas DA SPEDIRE em heroes_dispatch_pending_items.

    Política sconto (P1-c): discount_unit fica apenas nesta tabela. Não propagamos
    da_spedire.discount para ImportationItem.discount_amount_foreign até a Epic
    definir como o sconto da planilha afeta o custo da ordem.
    """
