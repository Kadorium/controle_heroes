...
**Checklist vivo:** [`CHECKLIST_MVP_IMPORTACAO_EPIC_V1.md`](../CHECKLIST_MVP_IMPORTACAO_EPIC_V1.md) — seção *Fase pós-MVP 6* (v2.7)
...
| [`CHECKLIST_MVP_IMPORTACAO_EPIC_V1.md`](../CHECKLIST_MVP_IMPORTACAO_EPIC_V1.md) | Status DONE e evidências (v2.7) |
