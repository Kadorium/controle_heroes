...
**Base:** MCK v0.3 + remediação R1–R18 (sem alteração de valores centrais).
...
| **T2** | MCK-006 (principal) | Preview: alocar 700 → saldo projetado 520 · residual projetado 0 |
