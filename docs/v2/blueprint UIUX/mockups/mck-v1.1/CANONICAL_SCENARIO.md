...
**Base:** MCK v0.4 + ajustes editoriais finais (sem alteração de valores centrais). **Aprovado** (Checkpoints A–D). Etapa 6B correções visuais (E6-001…006, 012, 018).
