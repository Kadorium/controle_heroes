...
const TABS = [
  ...
  {
    to: "/cadastros/produtos-pendentes",
    label: "Produtos pendentes",
    description: "Rascunhos Heroes aguardando cadastro definitivo",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    to: "/cadastros/limpeza",
    label: "Registros inativos",
    description: "Consultar ordens anuladas e limpeza definitiva do ambiente",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
