...
Porte V2 independente (sem import V1). Funções puras — sem I/O/ORM.
Owner: Ingestion (Blueprint §5.9); foothold Inc-6, não pipeline J#3.
"""
...
def parse_it_number(value: Any) -> Decimal | None:
    ...
    try:
        ...
        return _optional_decimal(cleaned)
...
def parse_it_date(value: Any) -> tuple[str | None, bool]:
    ...
    if isinstance(value, (int, float)):
        ...
        return (base + timedelta(days=float(value))).date().isoformat(), False
